...
报告固定包含“生涯议题与所处阶段、学生现状与现实约束、兴趣优势与价值偏好、教育与职业方向、选项比较与判断依据、行动计划与复盘节点、风险与待核实信息、支持资源与下一步”八部分，并带有 AI 生涯规划记录免责声明。模型未从对话中获得的信息会明确标为“本轮对话中未明确提及”，可能变化的外部信息会提示通过官方或可靠来源核实。
