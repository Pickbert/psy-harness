...
install -m 644 "$project_dir/Sources/DesktopPet/Resources/shiba-lift-blink.png" "$resources_dir/shiba-lift-blink.png"
...
plutil -replace CFBundleShortVersionString -string "0.4.14" "$contents_dir/Info.plist"
plutil -replace CFBundleVersion -string "18" "$contents_dir/Info.plist"
